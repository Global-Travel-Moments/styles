    ...
    Array.prototype.forEach.call(
      ...
      function (el) {
        list.push({
          ...
          place:   (el.getAttribute('data-place') || '').trim(),
          content: (el.getAttribute('data-content') || '').trim()
        });
      }
    );
