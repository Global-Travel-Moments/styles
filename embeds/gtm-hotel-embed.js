...
(function () {
  ...
  function initHotelBar(root) {
    ...
    datesSummary.className = 'shb-dates-words';
    ...
    var datesBox = checkIn.closest('.shb-dates-inner');
